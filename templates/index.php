...
<html lang="en">
  ...
  <body>
    <header>
      <div class="container">
        <div id="color-chooser">
          ...
          --!><span class="color" style="background-color: #333" data-shadow-color="#666"></span><!--
          ...
          --!><span class="color" style="background-color: #b7d595" data-shadow-color="#000"></span><!--
    ...
    <script src="js/vendor/require-jquery.js" data-main="js/main"></script>
